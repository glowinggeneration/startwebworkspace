...
| Component        | Source file                                   | Wired into                                | Notes                                                                                                                                                                                                                                                                                                             |
| ---------------- | --------------------------------------------- | ----------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Light Lines      | `vengeance/backgrounds/light-lines.tsx`       | Available, not currently displayed        | Removed from the public home screen in favour of its requested static white background. The component remains available for future use.                                                                                                                                                                           |
