...
export const StepPager: React.FC<StepPagerProps> = ({ steps = defaultItems, initialStep = 0 }) => {
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="relative flex h-16 min-w-[140px] items-center justify-center gap-1 rounded-full border-2 border-[#ECECEF] bg-[#fefefe] px-4 dark:border-[#2A2A33] dark:bg-[#14141A]">
          {steps.map((step, index) => {
            ...
            return (
              <div key={step.id} className="relative flex h-6 w-6 items-center justify-center">
                {isActive && (
                  <motion.div
