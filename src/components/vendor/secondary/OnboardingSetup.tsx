...
export const OnboardingSetup: React.FC<OnboardingSetupProps> = ({
  ...
  useEffect(() => {
    const handleClickOutside = (event: MouseEvent) => {
      if (revenueRef.current && !revenueRef.current.contains(event.target as Node)) {
      ...
      >
        ...
        <div className="inter order-2 flex flex-col lg:order-1">
          <div className="m-1.5 flex h-full flex-col rounded-[18px] bg-white p-5 shadow-sm sm:p-8 dark:bg-[#111]">
            ...
            <p className="mt-1 text-[12px] text-[#99999B] dark:text-[#666]">{subtitle}</p>
            ...
            <div className="mt-6 grid grid-cols-1 gap-4 lg:grid-cols-2">
              <div>
                <label className="text-[13px] font-normal text-[#979799]">Monthly revenue</label>
                      ...
                      >
                        {revenueOptions.map((option) => (
                          ...
                          >
                            ...
                            {revenue === option && (
                              <Check size={14} className="text-[#111] dark:text-[#EEE]" />
                            )}
                          </button>
                        ))}
                      </motion.div>
              ...
              <div>
                <label className="text-[13px] font-normal text-[#979799]">Your role</label>
                <input
                  value={role}
