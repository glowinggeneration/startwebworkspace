            ...
            >
              ...
              <div
                className={cn(
                  ...
                  isActive
                    ? "grid-rows-[1fr] border-l-neutral-900 dark:border-l-neutral-100 bg-neutral-100/50 dark:bg-neutral-800/30"
                    : "grid-rows-[0fr] border-l-neutral-300 dark:border-l-neutral-700 bg-transparent",
                )}
              >
