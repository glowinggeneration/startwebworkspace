...
export function SharedTooltipAvatars({ items, className, ...props }: SharedTooltipAvatarsProps) {
  ...
  return (
    <div className={cn("relative flex items-center justify-center py-12", className)} {...props}>
      <AnimatePresence>
        {hoveredIndex !== null && (
          <motion.div
            initial={{
